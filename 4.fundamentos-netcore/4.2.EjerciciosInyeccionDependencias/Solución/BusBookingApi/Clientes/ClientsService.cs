namespace BusBookingApi.Clientes
{
    ...
    public class ClientsService : IClientsService
    {
        ...
        public void CreateCliente(Cliente cliente)
        {
            ...
            {
                throw new ArgumentException("El cliente ya existe", nameof(cliente));
            }
        }
        ...
        public void DeleteCliente(string dni)
        {
            ...
            {
                throw new ArgumentException("El cliente no existe", nameof(dni));
            }
        }
    }
    ...
    public class ConcurrentClientsService : IClientsService
    {
        ...
        public void UpdateCliente(Cliente cliente)
        {
            _clientes.AddOrUpdate(cliente.Dni,
                (_) => throw new ArgumentException("El cliente no existe"),
                (_, _) => cliente);
        }
